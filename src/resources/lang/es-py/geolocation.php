...
return [
	...
	|--------------------------------------------------------------------------
	*/
    "api_places"                    => "API de Lugares",
    "api_places_provider"           => "Proveedor de servicio",
    ...
    "red_api_places_provider"       => "Proveedor de servicio de redundancia",
    "red_api_places_url"            => "URL del servidor de redundancia",
    "red_api_places_key"            => "Clave de autenticación de redundancia",
    "red_api_places_id"             => "ID de la aplicación de redundancia",   
    
    "save"                          => "Guardar",  

    "api_directions"                    => "API de Direcciones",
